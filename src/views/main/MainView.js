            ...
            <Card className={'MainView'} >
                  <Router>
                        ...
                        <Route element={<PrivateRoute/>}> 
                              ...
                              <Route exact path={PathList.updateProfile}      element={ <UpdateProfile/> }/>
                              <Route exact path={PathList.addParticipant}     element={ <AddParticipant/> }/>
                              ...
                              <Route exact path={PathList.home}
                                    element={ 
                                          auth.loginCheck() ? <Navigate to={PathList.dashboard}/> : <Login/> 
                                    }/>
                        ...
                        {/* Public Routes */}
                        <Route exact path={PathList.login} 
                              element={ auth.loginCheck() ? <Navigate to={PathList.dashboard}/> : <Login/> } />
                              
                        <Route exact path={PathList.forgotPassword} 
                              element={ auth.loginCheck() ? <Navigate to={PathList.updateProfile}/> : <ForgotPassword/> } />
