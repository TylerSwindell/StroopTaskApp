...
export default function SearchForm(props) {
    ...
    const classes = `d-flex flex-row align-items-center justify-content-center ${props.customClasses || ''}`
    const pidRef = useRef()
    ...
    async function handleQuery(e) {
        ...
        //console.log(e)
        const data = await queryDoc(e, "participants", pid)
    ...
    return (
        ...
        <Form className={classes}
            ...
            <Form.Control
                ...
                required
            />
            <Button type="submit" className="mt-3 mb-3" style={{width: '10rem'}} disabled={loading}>
                Search
            </Button>
